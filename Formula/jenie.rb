class Jenie < Formula
  ...
  homepage "https://github.com/Nattothemoon/jenie-releases"
  version "1.0.0"
  license "MIT"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/Nattothemoon/jenie-releases/releases/download/v1.0.0/jenie-darwin-arm64.tar.gz"
      ...
      url "https://github.com/Nattothemoon/jenie-releases/releases/download/v1.0.0/jenie-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/Nattothemoon/jenie-releases/releases/download/v1.0.0/jenie-linux-amd64.tar.gz"
